          ...
          <CardContent className="prose prose-gray max-w-none space-y-6">
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed">
                By accessing and using Globalist Media Suite, you accept and
            ...
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed">
                Globalist Media Suite is a comprehensive modular software
                platform designed for storytellers, media teams, and syndication
                partners. The Service provides tools for content creation,
                management, scheduling, analytics, and distribution across
                multiple platforms.
              </p>
            </section>
            ...
            <section>
              ...
              <div className="space-y-3">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  All intellectual property rights in the Service and its
                  original content remain the property of Globalist Media Suite
                  and its licensors.
                </p>
              </div>
            </section>
            ...
            <section>
              ...
              <div className="space-y-3">
                ...
                <ul className="list-disc list-inside space-y-2 text-muted-foreground ml-4">
                  ...
                  <li>
                    Promptly update account information if your payment method
                    changes
                  </li>
                  <li>
                    Accept that fees are non-refundable except as expressly
                    stated
                  </li>
                </ul>
              </div>
            ...
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed">
                In no event shall Globalist Media Suite be liable for any
            ...
            <section>
              ...
              <div className="bg-muted p-4 rounded-lg mt-3">
                ...
                <p className="text-muted-foreground">
                  Email: legal@globalistmedia.com
                </p>
                <p className="text-muted-foreground">
