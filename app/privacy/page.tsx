          ...
          <CardContent className="prose prose-gray max-w-none space-y-6">
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed">
                Globalist Media Suite is committed to protecting your privacy.
            ...
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed">
                ...
                preferences, though disabling cookies may affect the
            ...
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed">
                ...
                not apply to these external services, and we encourage you to
              ...
              <div className="space-y-3">
                ...
                <div className="bg-muted p-4 rounded-lg">
                  <p className="font-medium">
                    Globalist Media Suite - Privacy Team
                  </p>
                  <p className="text-muted-foreground">
                    Email: privacy@globalistmedia.com
                  </p>
                  <p className="text-muted-foreground">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    ...
                    have additional rights including the right to lodge a
                    complaint with a supervisory authority. Our lawful basis for
                    processing your personal information includes consent,
                    contract performance, legitimate interests, and legal
                    compliance.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    ...
                    information, including the right to know what personal
